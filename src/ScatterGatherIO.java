...
public class ScatterGatherIO {
	...
	public static void gatherBytes(String data) {
		...
		GatheringByteChannel gatherer = createChannelInstance("json-out.txt", true);// FileOutputStream
	...
	public static void scatterBytes() {
		...
		// The Second Buffer is used for holding a data that we want to write
		ByteBuffer buffer2 = ByteBuffer.allocate(400);
		ScatteringByteChannel scatter = createChannelInstance("json-out.txt", false);// FileInputStream
